...
def setup_amon_house():
    ...
    rooms["Front Gate"] = Room(
        ...
        scenery={
            ...
            "rusted gate": "The iron gate is rusted open just enough to admit you. Its bars are cold, wet, and flecked with old orange rust.",
            "rusted gates": "The iron gates are rusted open just enough to admit you. Their bars are cold, wet, and flecked with old orange rust.",
            "rusted iron gate": "The iron gate is rusted open just enough to admit you. Its bars are cold, wet, and flecked with old orange rust.",
            "rusted iron gates": "The iron gates are rusted open just enough to admit you. Their bars are cold, wet, and flecked with old orange rust."
        }
    )
    ...
    rooms["Cemetery"] = Room(
        ...
        {"north": "Front Gate"},
        items={"grave dirt": [
            "dirt", "soil", "grave soil", "loose grave dirt",
            "loose soil", "disturbed soil", "cemetery dirt", "wet dirt", "wet soil"
        ]},
        scenery={
            ...
            "old marker": "The grave marker is worn almost smooth. Only a few grooves remain deep enough to hold rainwater and shadow.",
    ...
    rooms["Front Door"] = Room(
        ...
        scenery={
            ...
            "brass knocker": "The gargoyle knocker is heavy brass, mounted exactly where a visitor's hand would fall. Its open mouth looks made for a hard, ringing knock, and a narrow nameplate marked AMON is fixed beneath its jaw.",
            "gargoyle knocker": "The gargoyle knocker is heavy brass, mounted exactly where a visitor's hand would fall. Its open mouth looks made for a hard, ringing knock, and a narrow nameplate marked AMON is fixed beneath its jaw.",
            ...
            "brass gargoyle": "The brass gargoyle is not just decoration. Its lower jaw hangs as a knocker, polished bright where other hands have lifted it. Beneath the jaw, a small nameplate gives the house its name: AMON.",
            ...
            "oak door": "The oak is ancient and scarred. It is currently locked tight, but the brass gargoyle knocker sits ready at the center panel above a narrow AMON nameplate.",
            "heavy oak door": "The oak is ancient and scarred. It is currently locked tight, but the brass gargoyle knocker sits ready at the center panel above a narrow AMON nameplate.",
            ...
            "narrow nameplate": "The narrow brass nameplate is fixed directly beneath the gargoyle knocker. The engraved letters are worn bright from weather and touch: AMON.",
            ...
            "narrow brass nameplate": "The narrow brass nameplate is fixed directly beneath the gargoyle knocker. The engraved letters are worn bright from weather and touch: AMON.",
            ...
            "amon plate": "The narrow brass nameplate is fixed directly beneath the gargoyle knocker. The engraved letters are worn bright from weather and touch: AMON.",
    ...
    rooms["Living Room"] = Room(
        ...
        scenery={
            ...
            "white bandage": "The white cloth around Mother's hand is fresh enough to shame the dust around it.",
            "white cloth": "The white cloth around Mother's hand is fresh enough to shame the dust around it.",
            "cloth": "The white cloth around Mother's hand is fresh enough to shame the dust around it.",
            "mother's bandage": "The white cloth around Mother's hand is fresh enough to shame the dust around it.",
            "mothers bandage": "The white cloth around Mother's hand is fresh enough to shame the dust around it.",
    ...
    rooms["Dining Room"] = Room(
        ...
        {"west": "Foyer"},
        items={"family photograph": [
            "photo", "photograph", "family photo", "face-down photo",
            "face-down photograph", "face down photo", "face down photograph",
            "old photo", "old photograph"
        ]},
        scenery={
            "table": "The plates are spotless, but one napkin is dotted with the brown shadow of dried blood.",
            "walnut table": "The plates are spotless, but one napkin is dotted with the brown shadow of dried blood.",
            "long walnut table": "The plates are spotless, but one napkin is dotted with the brown shadow of dried blood.",
            "chair": "The chair at the head of the table is carved with tiny eyes along its backrest.",
            "head chair": "The chair at the head of the table is carved with tiny eyes along its backrest.",
            "empty head chair": "The chair at the head of the table is carved with tiny eyes along its backrest.",
            "candelabrum": "The silver has gone black in places. Wax has pooled like old tears down its arms.",
            "silver candelabrum": "The silver has gone black in places. Wax has pooled like old tears down its arms.",
            "blackened silver candelabrum": "The silver has gone black in places. Wax has pooled like old tears down its arms.",
            ...
            "swollen sideboard": "The sideboard's swollen drawers smell of damp wood and old polish. Its surface has one clean rectangle in the dust where something was recently turned face-down.",
            "dusty sideboard": "The sideboard's swollen drawers smell of damp wood and old polish. Its surface has one clean rectangle in the dust where something was recently turned face-down."
        }
    )
    ...
    rooms["Study"] = Room(
        ...
        {"south": "Living Room"},
        items={
            "ritual ledger": ["ledger", "book", "ritual book", "old ledger", "household ledger", "family ledger"],
            "invitation card": ["card", "invitation", "formal invitation", "white card", "old invitation"]
        },
        scenery={
            "desk": "An old writing desk with one drawer slightly crooked, as if it has been forced open before.",
            "writing desk": "An old writing desk with one drawer slightly crooked, as if it has been forced open before.",
            "old writing desk": "An old writing desk with one drawer slightly crooked, as if it has been forced open before.",
            "drawer": "An old writing desk with one drawer slightly crooked, as if it has been forced open before.",
            "crooked drawer": "An old writing desk with one drawer slightly crooked, as if it has been forced open before.",
            "papers": "Birth dates, death dates, treatment notes, and household accounts. Someone kept records of everything.",
            "loose papers": "Birth dates, death dates, treatment notes, and household accounts. Someone kept records of everything.",
            "bookcase": "Dusty shelves of scripture, medicine, and family history lean over you like judges.",
            "bookcases": "Dusty shelves of scripture, medicine, and family history lean over you like judges.",
            "tall bookcases": "Dusty shelves of scripture, medicine, and family history lean over you like judges.",
    ...
    rooms["Kitchen"] = Room(
        ...
        items={
            "heavy axe": ["axe", "weapon", "kitchen axe", "big axe", "dull axe"],
            "silver spoon": ["spoon", "teaspoon", "silver teaspoon", "tea spoon"]
        },
        scenery={
            ...
            "stone hearth": "The stone hearth holds a cold blue flame that gives off light without comfort. Pale ash lies beneath it, ordinary at first glance, as if the fire has not decided whether to reveal what it has spared.",
            ...
            "cold blue flame": "The blue flame is thin and cold, bending without wind. It makes the kitchen shadows look sharpened rather than warmed.",
            ...
            "scarred worktable": "The scarred worktable has been scrubbed hard, but old cuts remain in the wood like half-erased instructions.",
            ...
            "hanging utensils": "The hanging utensils are clean enough to feel deliberate. Their shadows are longer than the tools themselves.",
    ...
    rooms["Upstairs Hallway"] = Room(
        ...
        scenery={
            ...
            "ancestor portrait": "The oil paintings form a severe family procession: AMON, ELISE, MARIUS, and HESTER. Their formal clothes belong to different decades, but every painted hand points subtly toward the attic stair.",
            ...
            "ancestor portraits": "The oil paintings form a severe family procession: AMON, ELISE, MARIUS, and HESTER. Their formal clothes belong to different decades, but every painted hand points subtly toward the attic stair.",
            ...
            "painted ancestors": "The painted ancestors look less like memorials than witnesses. Their nameplates are small, tarnished, and carefully polished around the edges.",
            "amon ancestors": "The painted ancestors look less like memorials than witnesses. Their nameplates are small, tarnished, and carefully polished around the edges."
        }
    )
    ...
    rooms["Attic Landing"] = Room(
        ...
        scenery={
            ...
            "heavy oak door": "The attic door is heavy oak, set north beneath the roofline. Its brass lock and ornate keyhole make it look less locked than expectant.",
            "oak door": "The attic door is heavy oak, set north beneath the roofline. Its brass lock and ornate keyhole make it look less locked than expectant.",
            ...
            "ornate keyhole": "You see a faint flickering light on the other side. At the edge of the narrow view, a rocking chair moves beside a small table with something pale set on top.",
            "large ornate keyhole": "You see a faint flickering light on the other side. At the edge of the narrow view, a rocking chair moves beside a small table with something pale set on top.",
            "lock": "The brass lock is old and cold. Its keyway is shaped for something small, precise, and unwilling to be forced.",
            "brass lock": "The brass lock is old and cold. Its keyway is shaped for something small, precise, and unwilling to be forced.",
            "dull brass lock": "The brass lock is old and cold. Its keyway is shaped for something small, precise, and unwilling to be forced.",
    ...
    rooms["Your Bedroom"] = Room(
        ...
        scenery={
            ...
            "guttering candle": "The candle gutters on the nightstand, too weak to comfort the room and too stubborn to go out.",
            "single candle": "The candle gutters on the nightstand, too weak to comfort the room and too stubborn to go out.",
    ...
    rooms["Attic"] = Room(
        ...
        items={
            "teapot": ["pot", "tea", "silver teapot", "lidded teapot", "ritual teapot"],
            "china teacup": [
                "cup", "teacup", "china cup", "tea cup",
        ...
        scenery={
            ...
            "violet steam": "The violet steam rises in delicate coils, but now and then it gathers into shapes too deliberate to be called accidental.",
            ...
            "small table": "A small table is set with a silver teapot and one china teacup, arranged with the precision of a place setting that has waited too long.",
    ...
    rooms["Cellar"] = Room(
        ...
        {"up": "Kitchen"},
        items={"sealed jar": [
            "jar", "souls", "glass jar", "sealed glass jar",
            "unlabelled jar", "unlabeled jar", "thick glass jar", "soul jar"
        ]}
    )
    ...
    rooms["Shed"] = Room(
        ...
        {"south": "Garden"},
        items={"sharpening stone": ["stone", "whetstone", "whet stone", "flat stone", "oily stone"]},
        scenery={
            ...
            "hanging tools": "Saws, hooks, shears, and rusted garden blades hang from the wall in careful rows. Most are too dull for honest work, but their edges still catch the moonlight.",
            ...
            "rusted garden blades": "Saws, hooks, shears, and rusted garden blades hang from the wall in careful rows. Most are too dull for honest work, but their edges still catch the moonlight.",
            ...
            "cluttered workbench": "The workbench is cluttered with oil stains, wood shavings, and the sharpening stone. Someone has kept this surface ready.",
            ...
            "cracked window": "The cracked window lets in a blade of moonlight. The glass is too dirty to show a clean reflection."
        }
    )
